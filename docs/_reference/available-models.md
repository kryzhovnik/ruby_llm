...
| claude-opus-4-6 | anthropic | In: text, image, pdf; Out: text | function_calling, reasoning, vision, streaming, batch, structured_output | 1000000 | 128000 | In: $5.00, Out: $25.00, Cache: $0.50 |
...
| claude-sonnet-4-6 | anthropic | In: text, image, pdf; Out: text | function_calling, reasoning, vision, streaming, batch, structured_output | 1000000 | 64000 | In: $3.00, Out: $15.00, Cache: $0.30 |
...
| claude-opus-4-6 | azure | In: text; Out: text | streaming | 4096 | 16384 | In: $0.50, Out: $1.50 |
| claude-sonnet-4-5-20250929 | azure | In: text; Out: text | streaming | 4096 | 16384 | In: $0.50, Out: $1.50 |
| claude-sonnet-4-6 | azure | In: text; Out: text | streaming | 4096 | 16384 | In: $0.50, Out: $1.50 |
...
| gpt-5-2025-08-07 | azure | In: text, image, pdf; Out: text | streaming, function_calling, structured_output, reasoning | 128000 | 400000 | In: $1.25, Out: $10.00, Cache: $0.12 |
...
| gpt-5-pro-2025-10-06 | azure | In: text, image, pdf; Out: text | streaming, function_calling, structured_output, reasoning | 128000 | 400000 | In: $1.25, Out: $10.00, Cache: $0.12 |
| gpt-5.1 | azure | In: text, image, pdf; Out: text | streaming, function_calling, structured_output, reasoning | 128000 | 400000 | In: $1.25, Out: $10.00, Cache: $0.12 |
| gpt-5.1-2025-11-13 | azure | In: text, image, pdf; Out: text | streaming, function_calling, structured_output, reasoning | 128000 | 400000 | In: $1.25, Out: $10.00, Cache: $0.12 |
...
| gpt-5.1-codex-2025-11-13 | azure | In: text, image, pdf; Out: text | streaming, function_calling, structured_output, reasoning | 128000 | 400000 | In: $1.25, Out: $10.00, Cache: $0.12 |
| gpt-5.1-codex-max-2025-12-04 | azure | In: text, image, pdf; Out: text | streaming, function_calling, structured_output, reasoning | 128000 | 400000 | In: $1.25, Out: $10.00, Cache: $0.12 |
...
| gpt-5.3-chat-2026-03-03 | azure | In: text, image, pdf; Out: text | streaming, function_calling, structured_output, reasoning | 128000 | 400000 | In: $1.25, Out: $10.00, Cache: $0.12 |
...
| mistral.magistral-small-2509 | bedrock | In: text, image; Out: text | function_calling, reasoning, vision, streaming | 128000 | 40000 | In: $0.50, Out: $1.50 |
...
| mistral.ministral-3-3b-instruct | bedrock | In: text, image; Out: text | function_calling, vision, streaming | 256000 | 8192 | In: $0.10, Out: $0.10 |
...
| mistral.mistral-large-3-675b-instruct | bedrock | In: text, image; Out: text | function_calling, vision, streaming | 256000 | 8192 | In: $0.50, Out: $1.50 |
...
| deepseek-reasoner | deepseek | In: text; Out: text | function_calling, reasoning, streaming | 128000 | 64000 | In: $0.28, Out: $0.42, Cache: $0.03 |
...
| gemini-3.1-flash-image-preview | gemini | In: text, image, pdf; Out: text, image | reasoning, vision, streaming, function_calling, structured_output, batch, caching | 131072 | 32768 | In: $0.25, Out: $60.00 |
| gemini-3.1-flash-lite-preview | gemini | In: text, image, video, audio, pdf; Out: text | function_calling, structured_output, reasoning, vision, streaming, batch | 1048576 | 65536 | In: $0.25, Out: $1.50, Cache: $0.02 |
...
| gemini-embedding-2-preview | gemini | In: text, image, pdf, video; Out: text, embeddings | streaming, function_calling, structured_output, batch, caching | 8192 | 1 | - |
...
| mistral-small-2603 | mistral | In: text; Out: text | streaming, function_calling, structured_output, batch, fine_tuning | 32768 | 8192 | - |
...
| mistral-squarepoint-2602 | mistral | In: text; Out: text | streaming, function_calling, structured_output, batch | 32768 | 8192 | - |
...
| voxtral-mini-tts-260213 | mistral | In: text; Out: text | streaming | 32768 | 8192 | - |
...
| gpt-5.4 | openai | In: text, image, pdf; Out: text | function_calling, structured_output, reasoning, vision, streaming | 1050000 | 128000 | In: $2.50, Out: $15.00, Cache: $0.25 |
...
| x-ai/grok-4.20-beta | openrouter | In: text, image; Out: text | function_calling, reasoning, vision, streaming, structured_output | 2000000 | 30000 | In: $2.00, Out: $6.00, Cache: $0.20 |
| x-ai/grok-4.20-multi-agent-beta | openrouter | In: text, image; Out: text | reasoning, vision, streaming, structured_output | 2000000 | 30000 | In: $2.00, Out: $6.00, Cache: $0.20 |
...
| openrouter/healer-alpha | openrouter | In: text, image, audio, pdf; Out: text | function_calling, structured_output, reasoning, vision, streaming | 262144 | 64000 | - |
...
| openrouter/hunter-alpha | openrouter | In: text, image, pdf; Out: text | function_calling, structured_output, reasoning, vision, streaming | 1048576 | 64000 | - |
...
| minimax/minimax-m2.5:free | openrouter | In: text; Out: text | streaming, function_calling, structured_output | 196608 | 196608 | - |
...
| nvidia/nemotron-3-super-120b-a12b:free | openrouter | In: text; Out: text | streaming, function_calling, structured_output | 262144 | 262144 | - |
...
| qwen/qwen3.5-9b | openrouter | In: text, image, video; Out: text | streaming, function_calling, structured_output, predicted_outputs | 256000 | - | In: $0.05, Out: $0.15 |
| qwen/qwen3.5-flash-02-23 | openrouter | In: text, image, video; Out: text | streaming, function_calling, structured_output | 1000000 | 65536 | In: $0.06, Out: $0.26 |
...
| z-ai/glm-5-turbo | openrouter | In: text; Out: text | streaming, function_calling, structured_output | 202752 | 131072 | In: $0.96, Out: $3.20, Cache: $0.19 |
...
| grok-4.20-beta-0309-non-reasoning | xai | In: text; Out: text | streaming, function_calling, structured_output | - | - | - |
| grok-4.20-beta-0309-reasoning | xai | In: text; Out: text | streaming, function_calling, structured_output | - | - | - |
| grok-4.20-multi-agent-beta-0309 | xai | In: text; Out: text | streaming, function_calling, structured_output | - | - | - |
